...
import { analyzePrescription, analyzeManualPrescription } from "../controllers/prescription.controller.js";
...
router.post("/manual", analyzeManualPrescription); // NEW: Manual medicine entry endpoint
